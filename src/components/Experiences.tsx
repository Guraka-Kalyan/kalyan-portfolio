...
const experiences = [
    {
        ...
        description: "Built and maintained internal CRM tools and business dashboards using the MERN stack. Integrated website contact form data into the dashboard using MongoDB, developed backend APIs for lead management, and deployed updates on AWS EC2 servers using SSH and Git.",
    }
];
